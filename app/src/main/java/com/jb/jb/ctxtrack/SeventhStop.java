...
public class SeventhStop extends Activity implements GooglePlayServicesClient.ConnectionCallbacks,GooglePlayServicesClient.OnConnectionFailedListener,LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    //private TextView stopNumber;
    //private TextView userId;

    private Button backInDelranButton;
    private Button arrivedSeventhStopButton;
    private Button departedSeventhStopButton;
    ...
    private String c;
    //private String d;
    private TextView userIdSeventhStop;
    ...
    public static final String TAG = SeventhStop.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seventh_stop);

        int resp = GooglePlayServicesUtil.isGooglePlayServicesAvailable(this);
        if(resp == ConnectionResult.SUCCESS){
            locationclient =      new GoogleApiClient.Builder(SeventhStop.this)
        ...
        arrivedSeventhStopButton = (Button) findViewById(R.id.arrivedToStop);
        departedSeventhStopButton = (Button) findViewById(R.id.departedSeventhStop);
        ...
        userIdSeventhStop = (TextView) findViewById(R.id.userIdStop7);
        ...
        Intent intent = getIntent();
        {
            ...
            userIdSeventhStop.setText(c);
        }

        arrivedSeventhStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        departedSeventhStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                arrivedSeventhStopButton.setEnabled(false);
    ...
    class InfoBegin44 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SeventhStop.this);
        ...
        protected String doInBackground(String... args) {
            ...
            intentUserId = userIdSeventhStop.getText().toString();
            String userId2 = userIdSeventhStop.getText().toString();
            String stopNumArrival = getResources().getString(R.string.stop7_arrival);
            String stopNumDeparture = getResources().getString(R.string.stop7_departure);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    if (arrivedClick == 0) {
                        Intent intent = new Intent(SeventhStop.this, EighthStop.class);
                        ...
                        Intent intent = new Intent(SeventhStop.this, BackInDelran.class);
                        if (intentNewTrailerNumber.isEmpty() || intentNewTrailerNumber.length() == 0 || intentNewTrailerNumber.equals("")) {
                            intent.putExtra("intentTrailerNumber", intentTrailerNumber);
                        } else {
                            intent.putExtra("intentTrailerNumber", intentNewTrailerNumber);
    ...
    class InfoBegin51 extends AsyncTask<String, String, String> {
