...
public class ThirdStop extends Activity implements GooglePlayServicesClient.ConnectionCallbacks,GooglePlayServicesClient.OnConnectionFailedListener,LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private Button arrivedThirdStopButton;
    private Button departedThirdStopButton;
    ...
    private String c;
    //private String d;
    private TextView userIdThirdStop;
    ...
    private float mph;
    public static final String TAG = ThirdStop.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_stop);

        int resp = GooglePlayServicesUtil.isGooglePlayServicesAvailable(this);
        if(resp == ConnectionResult.SUCCESS){
            locationclient =      new GoogleApiClient.Builder(ThirdStop.this)
        ...
        arrivedThirdStopButton = (Button) findViewById(R.id.arrivedToStop);
        departedThirdStopButton = (Button) findViewById(R.id.departedThirdStop);
        ...
        userIdThirdStop = (TextView) findViewById(R.id.userIdStop3);
        ...
        Intent intent = getIntent();
        {
            ...
            userIdThirdStop.setText(c);
        }

        arrivedThirdStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        departedThirdStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                arrivedThirdStopButton.setEnabled(false);
    ...
    class InfoBegin16 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ThirdStop.this);
        ...
        protected String doInBackground(String... args) {
            ...
            intentUserId = userIdThirdStop.getText().toString();
            String userId2 = userIdThirdStop.getText().toString();
            String stopNumArrival = getResources().getString(R.string.stop3_arrival);
            String stopNumDeparture = getResources().getString(R.string.stop3_departure);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    if (arrivedClick == 0) {
                        Intent intent = new Intent(ThirdStop.this, FourthStop.class);
                      ...
                      //  intent.putExtra("intentNewTrailerNumber", intentNewTrailerNumber);
                        ...
                        Intent intent = new Intent(ThirdStop.this, BackInDelran.class);
                        if (intentNewTrailerNumber.isEmpty() || intentNewTrailerNumber.length() == 0 || intentNewTrailerNumber.equals("")) {
                            intent.putExtra("intentTrailerNumber", intentTrailerNumber);
                        } else {
                            intent.putExtra("intentTrailerNumber", intentNewTrailerNumber);
    ...
    class InfoBegin17 extends AsyncTask<String, String, String> {
