...
public class EighthStop extends Activity implements GooglePlayServicesClient.ConnectionCallbacks,GooglePlayServicesClient.OnConnectionFailedListener,LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    //private TextView stopNumber;
    //private TextView userId;

    private Button backInDelranButton;
    private Button arrivedEighthStopButton;
    private Button departedEighthStopButton;
    ...
    private String c;
    //private String d;
    private TextView userIdEighthStop;
    ...
    public static final String TAG = EighthStop.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eighth_stop);

        int resp = GooglePlayServicesUtil.isGooglePlayServicesAvailable(this);
        if(resp == ConnectionResult.SUCCESS){
            locationclient =      new GoogleApiClient.Builder(EighthStop.this)
        ...
        arrivedEighthStopButton = (Button) findViewById(R.id.arrivedToStop);
        departedEighthStopButton = (Button) findViewById(R.id.departedEighthStop);
        ...
        userIdEighthStop = (TextView) findViewById(R.id.userIdStop8);
        ...
        Intent intent = getIntent();
        {
            ...
            userIdEighthStop.setText(c);
        }

        arrivedEighthStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        departedEighthStopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                arrivedEighthStopButton.setEnabled(false);
    ...
    class InfoBegin65 extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EighthStop.this);
        ...
        protected String doInBackground(String... args) {
            ...
            intentUserId = userIdEighthStop.getText().toString();
            String userId2 = userIdEighthStop.getText().toString();
            String stopNumArrival = getResources().getString(R.string.stop8_arrival);
            String stopNumDeparture = getResources().getString(R.string.stop8_departure);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    if (arrivedClick == 0) {
                        Intent intent = new Intent(EighthStop.this, NinthStop.class);
                        ...
                        Intent intent = new Intent(EighthStop.this, BackInDelran.class);
                        if (intentNewTrailerNumber.isEmpty() || intentNewTrailerNumber.length() == 0 || intentNewTrailerNumber.equals("")) {
                            intent.putExtra("intentTrailerNumber", intentTrailerNumber);
                        } else {
                            intent.putExtra("intentTrailerNumber", intentNewTrailerNumber);
    ...
    class InfoBegin60 extends AsyncTask<String, String, String> {
